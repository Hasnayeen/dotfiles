...
$sock = @fsockopen('127.0.0.1', 9912, $errno, $errstr, 1);
if (! $sock) {
    return false;
}
fclose($sock);
require '/home/hasnayeen/.config/composer/vendor/autoload.php';
...
// var_dump($fallbackDumper);
$fallbackDumper = new HtmlDumper();
VarDumper::setHandler(function (mixed $var) use ($cloner, $fallbackDumper): ?string {
